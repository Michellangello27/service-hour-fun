...
import { aLotServiceType, pendingReportsAmount, typeServices } from '../js/servicesFunctions'
        ...
        <>
            ...
            {info.role_id === 1 &&
                ...
                <div className='flex flex-wrap  justify-center'>
                    ...
                    <ResponsiveContainer width="60%" height={300} className='border w-[800px] h-[250px] rounded-md bg-white flex flex-col justify-center items-center shadow-2xl '>

                        <BarChart data={data3}>
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis tick={{ strokeWidth: 1, fontSize: 12 }} height={50} tickSize={10} dataKey="name" >
                                <Label value="Tipos de Reportes" offset={3} position="insideBottom" />
                            </XAxis>
                            <YAxis />
                            <Tooltip />
                    ...
                    <div className='border w-[300px] h-fit rounded-md bg-white flex flex-col justify-center items-center gap-7 p-2.5 shadow-2xl'>
                        <h2 className='text-[20px] text-center'>Relacion de Reportes - Horas</h2>
                                ...
                                <tbody>
                                    {data3.map((item) => {
                                        ...
                                        return (
                                            ...
                                            <tr key={item.name} className="border border-gray-400 text-center">
                                                <td>{item.name}</td>
